...
def main():
    ...
    for a_device in (pynet_rtr1, pynet_rtr2):
        ...
        if device_name in saved_devices:
            ...
            current_devices[device_name] = NetworkDevice(uptime, last_changed, False)
    nicer(current_devices)
    ''' looks like this
    {u'pynet-rtr2.twb-tech.com': NetworkDevice(uptime=1820703479, last_changed=1820699043, run_config_changed=False), u'pynet-rtr1.twb-tech.com': NetworkDevice(uptime=1950262745, last_changed=1949900580, run_config_changed=False)}
    '''
