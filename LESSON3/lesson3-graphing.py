...
fa4_out_octets = [5272, 5783, 7670, 6783, 5398, 5783, 9219, 3402, 5783, 6953, 5668, 5783]
...
#5 min intervals as we gathered the data above each 5 minutes => graph it accordingly
